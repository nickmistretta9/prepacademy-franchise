...
<head>
    ...
    <meta name="viewport" content="width=distice-width, initial-scale=1">
	...
	<nav class="navbar-default">
	    <div class="container-fluid">
	        <div id="st-trigger-effects" class="column mobile-buttons">
        		...
        		<a class="call mobile-ctc"><i class="fa fa-phone"></i> Call</a>
        		<a class="email mobile-ctc"><i class="fa fa-envelope"></i> Email</a>
